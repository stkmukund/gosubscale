...
export function Hero() {
  return (
    <section className="bg-cream">
      ...
      {/* Hero Content */}
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-5 py-12 sm:px-8 sm:py-16 md:py-20 lg:grid-cols-2 lg:gap-8 lg:py-24">
        ...
        <Reveal className="order-1 lg:order-2 relative flex items-center justify-center lg:justify-end" delay={120}>
          <div className="relative w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-[540px]">
            <div className="absolute -top-10 -right-4 sm:top-0 sm:right-4 -z-10 h-64 w-64 sm:h-80 sm:w-80 lg:h-96 lg:w-96 rounded-full bg-brand/30 blur-3xl pointer-events-none" />
            <img
              src="/images/hero-home.gif"
              alt="Smartphone displaying a SubScale transaction analytics dashboard"
              loading="eager"
              className="mx-auto lg:ml-auto lg:mr-0 h-auto w-full max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-[520px] object-contain drop-shadow-xl"
            />
          </div>
        </Reveal>
      </div>
